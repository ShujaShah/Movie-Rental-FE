...
const MovieGrid = ({ selectedGenre, setSearchTerm }) => {
  const { movies, error, isLoading } = useMovies(selectedGenre, setSearchTerm); //calling the custom hook for fetching the data
